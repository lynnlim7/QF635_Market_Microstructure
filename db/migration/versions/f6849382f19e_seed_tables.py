...
Revision ID: f6849382f19e
Revises: 94114ecee8a3
Create Date: 2025-05-30 17:04:30.395847
...
revision: str = 'f6849382f19e'
down_revision: Union[str, None] = '94114ecee8a3'
...
futures_positions = sa.Table(
    "futures_positions", metadata,
    sa.Column("position_id", sa.Integer, primary_key=True, autoincrement=True),
...
def upgrade() -> None:
    ...
    for _, v in ftr_pair_ids.items() :
        stmt = insert(futures_positions).values({
            "pair_id" : v,
            "amount" : 0.0
        })
        bind.execute(stmt)
